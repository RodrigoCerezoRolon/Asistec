            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        Editar Producto Especial
                        <a class="btn btn-outline-info float-right" href="{{route('productos-especiales.index')}}">
                            Volver
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="{{route('productos-especiales.update',$producto->id)}}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <h6>Titulo</h6>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    @else
                                    <img class="img-fluid" src="{{asset(Storage::url('images/noImg.jpg'))}}" width="300px" id="previewimg_uno">
                                    @endif
                                    ...
                                    <br>
                                    <small class="text-muted">Resolución Recomendada 606px * 317px</small>
                                </div>
                                <div class="col-md-6">
                                    <h6>Imagen Dos</h6>
                                    @if ($producto->img_dos)
                                    ...
                                    @else
                                    <img class="img-fluid" src="{{asset(Storage::url('images/noImg.jpg'))}}" width="300px" id="previewimg_dos">
                                    @endif
                                    <br>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @else
                                    <img class="img-fluid" src="{{asset(Storage::url('images/noImg.jpg'))}}" width="300px" id="previewimg_tres">
                                    @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    @else
                                    <img class="img-fluid" src="{{asset(Storage::url('images/noImg.jpg'))}}" width="300px" id="previewimg_cuatro">
                                    @endif
