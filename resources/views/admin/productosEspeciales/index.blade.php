            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        Editar Productos Especiales
                        <a href="{{route('productos-especiales.create')}}" class="btn btn-outline-info float-right">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <div class="form-button-action">
                                        <a   class="btn btn-link btn-primary btn-lg" href="{{route('productos-especiales.edit',$producto->id)}}">
