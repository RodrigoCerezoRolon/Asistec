...
$('#selectSubCats').on('change',(e)=>{
    ...
    $.ajax({
        type: "GET",
        url: url+"/filtrarPorSubCategoria/"+subcategoria,
        success: function(data) { 
            if(data==true){
...
$('#selectSub_SubCats').on('change',(e)=>{
    form.attr('action',url+'/BuscarSolucionSub-SubCategoria/'+  $('#selectSub_SubCats').val());
});